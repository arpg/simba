...
struct ClickHandler : pangolin::Handler3D
{
    ClickHandler();

    ClickHandler(SceneGraph::GLSceneGraph& graph, pangolin::OpenGlRenderState& cam_state, pangolin::AxisDirection enforce_up=pangolin::AxisNone, float trans_scale=0.01f)
