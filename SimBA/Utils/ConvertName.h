...
inline string GetRobotLastName(string sRobotFullName){
    string sLastName;
    int Index = sRobotFullName.find("@");
...
// Get first name from full name. format of Full name is
// FirstName@MiddleName@LastName. e.g. RCamera@Robot1@Proxy1
inline string GetFirstName(string sFullName){
    string sFirstName;
...
// Get last from full name. format of Full name is
// FirstName@MiddleName@LastName. e.g. RCamera@Robot1@Proxy1
inline string GetLastName(string sFullName){
    string sLastName;
...
inline string GetRobotNameFromFullName(string sFullName){
    string sRobotName;
    int Index = sFullName.find("@");
